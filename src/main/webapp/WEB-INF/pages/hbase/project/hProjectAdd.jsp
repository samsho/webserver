          ...
          <div class="col-xs-12 widget-container-col ui-sortable">
            <div class="widget-box widget-color-blue2 ui-sortable-handle">
              ...
              <div class="widget-body">
              	<form class="form-horizontal" action="${ctx}/hproject/save" method="post">
              		
              		<div class="form-group" id="div0">
						<div class="space-4"></div>
						<label class="col-sm-4 control-label no-padding-right" > 项目名称 <small style="color: red">*</small></label>
						<div class="col-sm-7">
							<input type="text" placeholder="" class="col-xs-7" name="projectName"  required data-bv-notempty-message="表名不可为空" maxlength="50"/>
						</div>
						<div class="space-4"></div>
					</div>
					...
					<div class="form-group" id="div1">
						<div class="space-4"></div>
						<label class="col-sm-4 control-label no-padding-right" > 项目代码 <small style="color: red">*</small> </label>
						<div class="col-sm-7">
							<input type="text" placeholder="" class="col-xs-7" name="projectCode"  required data-bv-notempty-message="表名不可为空" maxlength="50"/>
						</div>
						<div class="space-4"></div>
					</div>
              		<div class="form-group" id="div2">
						...
						<label class="col-sm-4 control-label no-padding-right"> 项目主负责 <small style="color: red">*</small></label>
						<div class="col-sm-7">
							<select id="mainPresiderId" name="mainPresiderId" class="js-example-basic-single" required data-bv-notempty-message="请选择集群">
					...
					<div class="form-group" id="div3">
						...
						<div class="col-sm-7">
							<select id="deputyPresiderIds" name="deputyPresiderIds"  class="js-example-basic-multiple" multiple="multiple" data-bv-notempty-message="请选择集群">
						    	<c:forEach items="${presiders}" var="presider">
					            	<option value="${presider.id}">${presider.name}</option>
								</c:forEach>
							</select>
					...
					<div class="form-group" id="div4">
						<div class="space-4"></div>
						<label class="col-sm-4 control-label no-padding-right" > 项目描述 <small style="color: red">*</small></label>
						<div class="col-sm-7">
							<textarea class="col-xs-7" name="projectDescription"  required data-bv-notempty-message="表名不可为空" maxlength="50"></textarea>
						</div>
						<div class="space-4"></div>
					</div>
